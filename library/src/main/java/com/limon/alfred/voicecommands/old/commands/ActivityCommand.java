...
{
    protected Activity associatedActivity;
    protected OutputObject object;
    
    /**
     * 
     */
    public ActivityCommand(OutputObject object)
    {
	this.object = object;
    }
    
    protected abstract void parseValues(Intent intent, OutputObject object);
