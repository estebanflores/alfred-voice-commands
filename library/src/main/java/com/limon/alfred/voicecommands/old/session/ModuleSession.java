 ...
 * 
 */
public class ModuleSession extends Session {
	...
	public ModuleSession() {
		this.box = new HashMap<String, Object>();
	}
	...
	public <T> T getFromBox(String key) {
		T result = (T) box.get(key);
		return result;
	}
	 ...
	 * 
	 */
	public <T> void putInBox(String key, T object) {
		box.put(key, object);
	}
}
